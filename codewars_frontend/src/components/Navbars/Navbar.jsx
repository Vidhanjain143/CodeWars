...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center gap-8 ">
        ...
        {user?<div className="text-lg  mr-10 hover:scale-105 hover:cursor-pointer flex" onClick={()=>setLoggedUserClick(!loggedUserClick)}> 
        ...
        {user && loggedUserClick && (<div className='text-white ml-[-20px]' onClick={()=>dispatch(signout)}><IoIosLogOut size='30px'/></div>)}
    </div>
    </div>
